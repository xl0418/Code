...
diversity.upperlimit = 1200
diversity.lowerlimit = 90
lowcol = "#F2F0F7"
highcol = '#54278F'
tas1 = list()
...
if(i_n == 1){
  tas1 <-    ggplot( df , aes(factor(psi), factor(phi)  ) ) + 
...
grid.arrange(grob1,grob2,mylegend,grob3,grob4,grob3,ncol = 3, widths = c(1,8,2),heights = c(10,1))
