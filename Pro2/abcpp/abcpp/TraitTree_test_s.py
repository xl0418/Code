...
for no_tree in range(1, 4):
    ...
    dir_path = '/mnt/c/Liang/Googlebox/Research/Project2'
        ...
        for index_a in range(len(a_vec)):
            ...
            if index_a >= index_g:
                for replicate in range(100):
                    obs_param = DVParamLiang(gamma=gamma1, a=a, K=K, h=1, nu=nu, r=r, theta=theta,
                                             V00=.0001, V01=.0001, Vmax=1, inittrait=0, initpop=500,
                                        initpop_sigma=10.0, break_on_mu=False,num_threads=1)
            ...
            count += 1
    dir_fig = '/mnt/C/Liang/Googlebox/Research/Project2/abundance_test/' + tree
