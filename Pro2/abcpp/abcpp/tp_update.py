...
def tp_update(previous_bestfitted_model,propose_model,params_TP,weight_gamma_TP,weight_a_TP,weight_nu_TP):
    ...
    nu_pre_var_TP = np.sum((previous_a_TP - nu_pre_mean_TP) ** 2 * weight_nu_TP)
    ...
    weight_gamma_numerator_TP = norm.pdf(propose_gamma_TP, gamma_pre_mean_TP, gamma_pre_var_TP)
    ...
    weight_a_numerator_TP = norm.pdf(propose_a_TP, a_pre_mean_TP, a_pre_var_TP)
    ...
    weight_nu_numerator_TP = norm.pdf(propose_nu_TP, nu_pre_mean_TP, nu_pre_var_TP)
