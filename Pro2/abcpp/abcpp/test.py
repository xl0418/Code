...
nu = 1e-4
meantrait = 1300
gamma_TVM_est =  7.539611977498784e-10 #np.mean(gamma_TVM[fit_index_TVM])
a_TVM_est = 0.00021762021948271803 #np.mean(a_TVM[fit_index_TVM])
nu_TVM_est =0.00036982608897495085 # np.mean(nu_TVM[fit_index_TVM])
...
obs_param = DVParamLiang(gamma=gamma_TVM_est, a=a_TVM_est, K=1e12, h=1, nu=nu_TVM_est, r=1, theta=meantrait,
                         V00=.5,V01=.5, Vmax=30, inittrait=meantrait, initpop=1e5,
                     initpop_sigma=10.0, break_on_mu=False)
