...
obs_param = DVParam(gamma=gamma, a=a, K=100000, nu=0.0001, r=1, theta=0, Vmax=1, inittrait=0, initpop=500,
                    split_stddev=0.2)
...
para_data = {'gamma': gamma_data, 'a': a_data, 'fitness':fitness_data}
