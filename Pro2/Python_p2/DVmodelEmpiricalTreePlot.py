...
#full tree
dir_path = 'c:/Liang/Googlebox/Research/Project2/treesim_newexp/'

# dir_path = 'c:/Liang/Googlebox/Research/Project2/planktonic_foraminifera_macroperforate/'
files = dir_path + 'largetree/'
# parameter settings
td = DVTreeData(path=files, scalar=1000)

obs_param = DVParam(gamma=gamma1, a=a, K=K, nu=nu, r=r, theta=theta, Vmax=1, inittrait=10, initpop=50000,
