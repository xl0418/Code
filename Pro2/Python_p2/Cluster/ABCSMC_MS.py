from ABC_SMC_DVmodel1 import SMC_ABC_MS, single_trait_sim
...
SMC_ABC_result = SMC_ABC_MS(timestep = timestep, particlesize = particlesize, obs = obs, prior = prior, epsilon = epsilon,file = file)
pickle.dump( SMC_ABC_result, open( "/home/p274981/Python_p2/DVmodel/SMC_ABC_MS_result_DV.p", "wb" ) )
...
# g_ori.savefig("/home/p274981/Python_p2/DVmodel/SMC_ABC_result_DV.png")
