...
simresult = DVtraitsim_tree(file = file, replicate = 13, gamma1 = par_obs[0], a = par_obs[1],scalor = 1000)
...
posterior = MCMC_ABC(startvalue= startvalue_par, iterations = iterations, delta = delta, obs = obs,sort = 1,
                    priorpar=priorpar, file = file, mode = 'uni')
file2 = file + 'posterior4w_DVuni.txt'
